...
`;
  ...
  async generateTestScenarios(
    ...
    const prompt = `
You are an expert test automation engineer. Generate comprehensive test scenarios for the following webpage.
...
Generate 5-10 test scenarios that would be most valuable for this webpage. Each scenario should:
1. Be specific and actionable
2. Cover different types of testing (functional, usability, edge cases)
  ...
  "scenarios": [
    {
      ...
      "priority": "high|medium|low",
      "category": "authentication|forms|navigation|usability|performance|security",
      "steps": ["Step 1", "Step 2", ...],
