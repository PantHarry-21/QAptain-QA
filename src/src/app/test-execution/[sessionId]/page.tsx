...
export default function TestExecutionPage() {
  ...
  const handlePauseTest = () => {
    socket?.emit('pause-test', { sessionId });
  };

  const handleResumeTest = () => {
    socket?.emit('resume-test', { sessionId });
  };
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                {testStatus === 'running' && (
                  <>
                    <Button onClick={handlePauseTest} variant="outline">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span>{progress.currentScenario} / {progress.totalScenarios}</span>
                  </div>
                  <Progress 
                    value={(progress.currentScenario / progress.totalScenarios) * 100} 
                    className="h-2" 
                  />
                </div>
              ...
              <div className="flex items-center gap-4 text-sm text-slate-600 dark:text-slate-400">
                ...
                {progress.estimatedEndTime && (
                  <div className="flex items-center gap-1">
                    <Clock className="w-4 h-4" />
                    Est. End: {formatTime(progress.estimatedEndTime)}
                  </div>
                )}
              </div>
            </CardContent>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
                ...
                {testStatus === 'idle' ? (
                  ...
                  <div className="flex items-center justify-center h-full">
                    <div className="text-center">
                      ...
                      <p className="text-slate-600 dark:text-slate-400">
                        Browser view will appear here during execution
                      </p>
                    </div>
                  </div>
                )}
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Real-time logs and test execution details
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="space-y-2">
                  {logs.length === 0 ? (
                    <div className="text-center py-8 text-slate-500">
                      No logs yet. Start the test to see execution logs.
                    </div>
                  ) : (
                    logs.map((log) => (
                      <div
